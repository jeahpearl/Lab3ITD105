...
section = st.sidebar.radio("Go To", ["Train Model", "Lung Cancer Diagnosis Predictor"])

if section == "Train Model":
    st.header("Train a Classification Model")

    # Load the dataset from predefined path
    dataset_path = r"C:\Users\jeahp\Desktop\ITD105\Lab3\csv\survey lung cancer.csv"
    try:
        ...
        if target_column and feature_columns:
            ...
            if "trained_model" in st.session_state and st.session_state["trained_model"]:
                if st.button("Save Model", key="save_model_button"):
                    save_folder = r'C:\Users\jeahp\Desktop\ITD105\Lab3\Models\classification'
...
elif section == "Lung Cancer Diagnosis Predictor":
    st.header("Lung Cancer Diagnosis Predictor")

    # Predefined models directory
    models_directory = r"C:\Users\jeahp\Desktop\ITD105\Lab3\Models\classification"
